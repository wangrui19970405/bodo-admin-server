...
import (
	...
	sysModel "github.com/wangrui19970405/wu-shi-admin/server/model/system"
	...
	entities := []sysModel.SysUser{
		{
			...
			NickName:    "研发",
			HeaderImg:   "https://huaduogiegie.oss-cn-shanghai.aliyuncs.com/picgo/202305281629232.png",
			AuthorityId: 999,
			Phone:       "18888888888",
...
func (i *initUser) DataInserted(ctx context.Context) bool {
	...
	return len(record.Authorities) > 0 && record.Authorities[0].AuthorityId == 999
}
