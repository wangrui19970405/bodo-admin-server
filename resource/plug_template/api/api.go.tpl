...
{{ if .NeedModel }}	"github.com/wangrui19970405/wu-shi-admin/server/plugin/{{ .Snake}}/model" {{ end }}
	"github.com/wangrui19970405/wu-shi-admin/server/plugin/{{ .Snake}}/service"
...
func (p *{{ .PlugName}}Api) ApiName(c *gin.Context) {
    ...
    {{ end }}
		...
		global.WUSHI_LOG.Error("失败!", zap.Error(err))
